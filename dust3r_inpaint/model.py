...
class DUSt3R_InpaintModel (AsymmetricCroCo3DStereo):
    """ 
    """
    ...
    def _set_patch_embed(self, img_size=224, patch_size=16, enc_embed_dim=768):
        #TIP: input_channels=rgb(3)+pts3d(3)+mask(1)
        self.enc_embed_dim = enc_embed_dim
        self.patch_size = patch_size
        self.patch_embed = get_patch_embed(self.patch_embed_cls, img_size, patch_size, enc_embed_dim, input_channels=7)
